...
-- bindOptional f (Optional x) = f x -- this doesn't work because Optinal is a type and we can't pass in a type definition but only constructor

--OPTION 2 using map
{- Bind using map -}
bindOptional f o =
  case mapOptional f o of
    Full (Full a) -> Full a
    Empty -> Empty
